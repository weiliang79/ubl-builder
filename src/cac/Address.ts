...
const ParamsMap: IGenericKeyValue<ParamsMapValues> = {
  addressTypeCode: { order: 2, attributeName: 'cbc:AddressTypeCode', min: 0, max: 1, classRef: UdtCode },
  addressFormatCode: { order: 3, attributeName: 'cbc:AddressFormatCode', min: 0, max: 1, classRef: UdtCode },
  postbox: { order: 4, attributeName: 'cbc:Postbox', min: 0, max: 1, classRef: UdtText },
  floor: { order: 5, attributeName: 'cbc:Floor', min: 0, max: 1, classRef: UdtText },
  room: { order: 6, attributeName: 'cbc:Room', min: 0, max: 1, classRef: UdtText },
  streetName: { order: 7, attributeName: 'cbc:StreetName', min: 0, max: 1, classRef: UdtName },
  additionalStreetName: { order: 8, attributeName: 'cbc:AdditionalStreetName', min: 0, max: 1, classRef: UdtName },
  blockName: { order: 9, attributeName: 'cbc:BlockName', min: 0, max: 1, classRef: UdtName },
  buildingName: { order: 10, attributeName: 'cbc:BuildingName', min: 0, max: 1, classRef: UdtName },
  buildingNumber: { order: 11, attributeName: 'cbc:BuildingNumber', min: 0, max: 1, classRef: UdtText },
  inhouseMail: { order: 12, attributeName: 'cbc:InhouseMail', min: 0, max: 1, classRef: UdtText },
  department: { order: 13, attributeName: 'cbc:Department', min: 0, max: 1, classRef: UdtText },
  markAttention: { order: 14, attributeName: 'cbc:MarkAttention', min: 0, max: 1, classRef: UdtText },
  markCare: { order: 15, attributeName: 'cbc:MarkCare', min: 0, max: 1, classRef: UdtText },
  plotIdentification: { order: 16, attributeName: 'cbc:PlotIdentification', min: 0, max: 1, classRef: UdtText },
  citySubdivisionName: { order: 17, attributeName: 'cbc:CitySubdivisionName', min: 0, max: 1, classRef: UdtName },
  postalZone: { order: 19, attributeName: 'cbc:PostalZone', min: 0, max: 1, classRef: UdtText },
  region: { order: 22, attributeName: 'cbc:Region', min: 0, max: 1, classRef: UdtText },
  district: { order: 23, attributeName: 'cbc:District', min: 0, max: 1, classRef: UdtText },
  timezoneOffset: { order: 24, attributeName: 'cbc:TimezoneOffset', min: 0, max: 1, classRef: UdtText },
